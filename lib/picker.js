    ...
    getCategories: function () {
      ...
      _.each(this.props.categories, function (details, key) {
        headers.push(React.createElement(
          ...
          React.createElement(Emoji, { role: "menuitem", "aria-label": key + " category", shortname: ":" + details.emoji + ":", onTouchTap: function () {
              jumpToCategory(key);
            } })
        ));
      }.bind(this));
          ...
          list = _.map(list, function (data) {
            ...
            if (!search || !term || modified.keywords.some(function (keyword) {
              ...
              return React.createElement(
                ...
                React.createElement(Emoji, _extends({}, modified, { "aria-label": modified.name, role: "option", onTouchTap: function () {
                    onChange(modified);
                  } }))
              );
            }
